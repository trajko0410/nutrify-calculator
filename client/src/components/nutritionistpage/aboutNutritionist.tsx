...
import AboutNutritionLoader from "../skeletonLoaders/aboutNutritionLoader"
...
const AboutNutritionist: React.FC<AboutNutritionistProps> = ({
    ...
    const [nutritionist, setNutritionst] = useState<Nutritionist | undefined>()
    ...
    useEffect(() => {
        ...
        setNutritionst(nutritionistProp)
        setLoading(false)
    }, [nutritionistProp])
    ...
    if (!nutritionist) {
        return (
            <div className="shadow-Combined font-Poppins flex h-full min-h-[200px] flex-col justify-between gap-8 rounded-xl bg-[#FFFFFF] px-[20px] py-[17px] md:flex-row">
                No nutritionist at this momment
            </div>
        )
    }
